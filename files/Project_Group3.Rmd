...
# Hocanın datayı almak için yazdığı kod buraları değiştirmeyin
...
library(ggcorrplot)
ggcorrplot(cor(corr) ,hc.order = TRUE, type = "upper",lab = TRUE, title = "Correlation Matrix", show.legend = TRUE
         )
...
You can reach my related code from [here](https://bu-ie-360.github.io/spring21-oyahobann/Files/Project_Group3.Rmd).
# REFERENCES
